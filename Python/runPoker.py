...
if __name__ == "__main__":
    ...
    deckOfGates = {"H": nPlayers, "X": nPlayers, "ZH": nPlayers, "CX": nPlayers, "Y": nPlayers, "S": nPlayers}
    ...
    while not count_nonzero(money == 0) == (nPlayers-1):
        pokerGame = PokerGame(deckOfGates, nPlayers, money, names = names, smallBlind=5, smallBlindPlayer=dealer, enableEntanglement = enableEntanglement)
